...
class Ui_MainFunction(QtWidgets.QWidget):
    ...
    swtiched_to_booksManager = pyqtSignal()
    ...
    def setupUi(self, MainFunction):
        ...
        self.pushButton_7.setGeometry(QtCore.QRect(700, 270, 230, 70))
        ...
        self.pushButton_5.clicked.connect(self.switch_to_books_manager)
      
        self.pushButton_8.clicked.connect(self.close)
        self.pushButton_7.clicked.connect(SQLConnect.Export_Data)
    ...
    def retranslateUi(self, MainFunction):
        ...
        self.pushButton_5.setText(_translate("MainFunction", "后勤管理（图书管理）"))
        # self.pushButton_6.setText(_translate("MainFunction", "教学管理"))
        self.pushButton_7.setText(_translate("MainFunction", "导出所有数据"))
    ...
    def switch_to_books_manager(self):
        self.swtiched_to_booksManager.emit()