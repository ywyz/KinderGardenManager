...
class Ui_ChangeUser(QtWidgets.QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.lineEdit.setGeometry(QtCore.QRect(750, 290, 241, 41))
        self.lineEdit.setObjectName("lineEdit")
        self.label = QtWidgets.QLabel(parent=Form)
        self.label.setGeometry(QtCore.QRect(500, 290, 281, 41))
        font = QtGui.QFont()
        ...
        self.label_2.setGeometry(QtCore.QRect(500, 360, 281, 41))
        font = QtGui.QFont()
        font.setFamily("Adobe 黑体 Std R")
        font.setPointSize(12)
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(750, 350, 241, 41))
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.pushButton = QtWidgets.QPushButton(parent=Form)
        self.pushButton.setGeometry(QtCore.QRect(500, 570, 131, 51))
        font = QtGui.QFont()
        font.setFamily("Adobe 黑体 Std R")
        font.setPointSize(12)
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(700, 570, 131, 51))
        font = QtGui.QFont()
        font.setFamily("Adobe 黑体 Std R")
        font.setPointSize(12)
        ...
        self.label_3.setGeometry(QtCore.QRect(500, 430, 281, 41))
        font = QtGui.QFont()
        font.setFamily("Adobe 黑体 Std R")
        font.setPointSize(12)
        ...
        self.lineEdit_3.setGeometry(QtCore.QRect(750, 420, 241, 41))
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.pushButton_3 = QtWidgets.QPushButton(parent=Form)
        self.pushButton_3.setGeometry(QtCore.QRect(900, 570, 131, 51))
        font = QtGui.QFont()
        font.setFamily("Adobe 黑体 Std R")
        font.setPointSize(12)
        ...
        self.label_4.setGeometry(QtCore.QRect(500, 500, 281, 41))
        font = QtGui.QFont()
        font.setFamily("Adobe 黑体 Std R")
        font.setPointSize(12)
        ...
        self.comboBox.setGeometry(QtCore.QRect(750, 500, 221, 31))
        font = QtGui.QFont()
        font.setFamily("Adobe 黑体 Std R")
        font.setPointSize(12)
