...
class Ui_StudentsBasicManager(QtWidgets.QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(400, 360, 231, 71))
        font = QtGui.QFont()
        font.setFamily("Adobe 黑体 Std R")
        font.setPointSize(12)
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(700, 180, 231, 71))
        font = QtGui.QFont()
        font.setFamily("Adobe 黑体 Std R")
        font.setPointSize(12)
        ...
        self.pushButton_5.setGeometry(QtCore.QRect(400, 270, 231, 71))
        font = QtGui.QFont()
        font.setFamily("Adobe 黑体 Std R")
        font.setPointSize(12)
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_2.setText(_translate("Form", "删除单名幼儿"))
        self.pushButton_3.setText(_translate("Form", "新增单名幼儿"))
        self.pushButton_4.setText(_translate("Form", "返回"))
        self.pushButton_5.setText(_translate("Form", "查看班级所有幼儿信息"))
